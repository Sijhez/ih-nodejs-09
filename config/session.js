//para la gestion de la sesión:
//configuracion, tiempo de expiracion de la sesión, etc
...
const sessionManager = (app)=>{
  ...
  app.use (session({
      secret: process.env.SESSION,//Palabra secreta para coincidir en el servidor al momento de generar cookie de sesion
...
//al invocar la funcion, le debemos pasar un argumento :3
